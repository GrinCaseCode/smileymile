...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
  ...
  jQuery('.quantity').each(function() {
	...
	$('.slider-rent-nav').each(function() { 
     var numb_text =  $(this).find( ".slick-track > .slick-slide" ).length;
     $(this).siblings(".numbers-rent").find("span").text(numb_text);
      console.log(numb_text);
    });
...
$('.tabs-page li a').click(function(event) {
		...
		$(this).parent().addClass('active');
		$(this).parent().parent().siblings(".tab-container-page").find(".tab-pane-page").removeClass("active");
		var selectTab = $(this).attr("href");
		$(selectTab).addClass("active");
	});

$('.tabs-rent li a').click(function(event) {
		event.preventDefault();
		$(this).parent().parent().find("li").removeClass('active');
		$(this).parent().addClass('active');
		$(this).parent().parent().siblings(".tab-container-rent").find(".tab-pane-rent").removeClass("active");
		var selectTab = $(this).attr("href");
		$(selectTab).addClass("active");
	});
